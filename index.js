...
const sessdata = config.SESSION_ID.replace("NET~CRASH~V1", '');
...
async function connectToWA() {
  ...
  conn.ev.on('connection.update', (update) => {
    ...
    if (connection === 'close') {
      ...
      console.log('NETCRASH-V1 CONNECTED SUCCESSFULLY ✅');

try {
        await changeAbout(conn, `JUST ME DEV JON SNOW.`);
      ...
      let up = `
╭──── ❏ *👋 Welcome NETCRASH-V1 User!*
│
├ 🎯 *Simple. Straightforward. Powerful.*
│   Meet *NETCRASH-V1* – your personal crash bot!
│
├ 🚀 *Features Loaded*
│   - Auto Flood
│   - Device Detector
...
│
├ ⭐ *Support us:*
│   https://github.com/jon-snow-tech-bot/NETCRASH-V1 
│
╰─ © Powered by *JON TECH 🖤*
`;
